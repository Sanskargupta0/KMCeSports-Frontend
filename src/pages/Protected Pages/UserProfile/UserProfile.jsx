  ...
  useEffect(() => {
    if (userdata) {
      setUser({
        ...
        instagram: userdata.instagram,
        tournaments: {
          participated: userdata.tournaments.participated,
          won: userdata.tournaments.won,
        },
      });
    }
  }, [userdata]);
                    ...
                    >
                      <div className="col-sm-4 bg-c-lite-green user-profile">
                        <div className="card-block text-center text-white">
                          ...
                          <p style={{ color: "#47f252", fontSize: "1.5rem" }}>
                            @{user.userName}
                          </p>
                      ...
                      <div className="col-sm-8">
                        <div className="card-block">
                          ...
                          <div className="row">
                            <div className="col-sm-6">
                              <p className="m-b-10 f-w-600">Participated</p>
                              <h6 className="text-muted f-w-400">
                                {user.tournaments.participated}
                              </h6>
                            </div>
                            <div className="col-sm-6">
                              <p className="m-b-10 f-w-600">Won</p>
                              <h6 className="text-muted f-w-400">
                                {user.tournaments.won}
                              </h6>
                            </div>
                          </div>
